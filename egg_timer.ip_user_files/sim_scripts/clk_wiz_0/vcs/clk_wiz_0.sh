...
#
# Generated by Vivado on Mon Mar 31 20:57:03 -0400 2025
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../egg_timer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../egg_timer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
